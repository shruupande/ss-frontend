 ...
 */
class Meigee_ThemeOptions_Block_Html_Topmenu extends Mage_Page_Block_Html_Topmenu
{
    ...
    {
        $menuContent = MAGE::helper('ThemeOptions')->getThemeOptions('menu');
        $html = '';
        ...
        foreach ($children as $child) {
            ...
            if ($child->hasChildren()) {
                ...
                if ($navigation['type'] == 'menu_wide' && $menuContent['additional'] ) {
                    ...
                    if(Mage::helper('ThemeOptions')->isActive('identifier', $child->getId()) && $childLevel == 0) {
